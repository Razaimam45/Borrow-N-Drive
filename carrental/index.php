...
<title>Borrow-N-Drive: Car Rental Portal</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <p><h1>BORROW-N-DRIVE</h1></p>
            <p>Get easy to book car rental deals.</p>
            <p>Big-Small-Luxurious-Economical-Reliable</p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Need A Car ? <span></span></h2>
      <p>Borrow-N-Drive has open its door to fulfill all car rental needs of the travelers, tourists, shoppers and business peoples.
      Quality Customer Service, and a wide-ranging selection of the newest cars is given to us an excellent reputation. We want to be known as the Company that resolves your tranportation service coupled with a commitment to the highest level of customer service that you can find.</p>
    </div>
    <div class="row"> 
  ...
  <div class="container div_zindex"> 
    <div class="row"> 
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3"> 
        <div class="fun-facts-m"> 
          <div class="cell"> 
            <h2><i class="fa fa-car" aria-hidden="true"></i>1100+</h2> 
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3"> 
        <div class="fun-facts-m"> 
          <div class="cell"> 
            <h2><i class="fa fa-user-circle-o" aria-hidden="true"></i>1500+</h2> 
