        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <p class="uppercase_text">For Any Query Mail us : </p>
              <a href="mailto:info@example.com">csamu@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Helpline No.</p>
              <a href="tel:61-1234-5678-09">+91-1234567890</a> </div>
            <div class="social-follow">
              <ul>
                <li><a href="https://m.facebook.com/"><i class="fa fa-facebook-square" aria-hidden="true"></i></a></li>
...
echo "Welcome To Borrow-N-Drive";
 } ?>
          </div>
        </div>
      </div>
...
foreach($results as $result)
	{
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
          ...
          <li><a href="my-testimonials.php">My Testimonial</a></li>
            ...
            <?php } else { ?>
            <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">My Profile</a></li>
